...
async def trigger_specific_attack(attack_type: str, target_mode: str):
    ...
    target_url = "http://127.0.0.1:8000/api/v1/predict" if target_mode == "undefended" else "http://127.0.0.1:8001/api/v1/predict"
    args = ["--attack", attack_type, "--target", target_url]
...
async def trigger_eval(target_mode: str, include: str = "knockoff,jbda,analytical,evolutionary"):
    ...
    target_url = "http://127.0.0.1:8000/api/v1/predict" if target_mode == "undefended" else "http://127.0.0.1:8001/api/v1/predict"
    args = ["--attack", "eval", "--target", target_url, "--include", include]
